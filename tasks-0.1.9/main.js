...
var ver = 'core-0.1.8';//version provided via grunt builds - this var will be replaced to actual value
var agoModule = 'tasks';//module name and
var agoVer = 'tasks-0.1.9';   //version (provided only on module build, so, optional)
