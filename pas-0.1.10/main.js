...
var ver = 'core-0.1.9';//version provided via grunt builds - this var will be replaced to actual value
var agoModule = 'pas';//module name and
var agoVer = 'pas-0.1.10';   //version (provided only on module build, so, optional)
